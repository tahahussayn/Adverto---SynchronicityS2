...
<div className="glass-panel-heavy rounded-xl p-md w-full max-w-[384px] mx-auto flex flex-col gap-4 relative glow-accent mt-8">
    ...
    <Link href="/auth" className="w-full bg-white text-[#0A0A0A] font-label-sm font-bold py-3 rounded-lg hover:scale-105 transition-transform duration-200 glow-accent-hover flex items-center justify-center gap-2 shadow-lg">
