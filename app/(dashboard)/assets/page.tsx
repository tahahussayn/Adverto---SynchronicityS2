  ...
  return (
    <div className="flex-1 flex flex-col min-w-0 px-sm md:px-lg py-lg h-full">
      ...
      <section className="flex-1 flex flex-col items-center justify-center text-center max-w-md w-full mx-auto py-xl">
        ...
        <h2 className="font-headline-lg text-headline-lg-mobile md:text-headline-lg text-on-surface mb-2">No assets yet</h2>
        <p className="font-body-md text-body-md text-on-surface-variant mb-lg">Upload images and videos to use in your campaigns.</p>
        <button className="text-on-surface hover:text-primary font-label-sm text-label-sm flex items-center gap-xs transition-colors duration-300 border border-outline-variant px-md py-sm rounded-DEFAULT hover:border-primary/50 hover:bg-primary/5">
